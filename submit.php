          ...
          <div class="container">
            <div class="row">
                <?php
                    ...
                    $db=mysqli_connect('localhost','root','','actionplan');
                    ...
                    $team7 = $_POST['team7'];
                    $team8 = $_POST['team8'];
                    $reg_startup = $_POST['reg_startup'];
                    $internet_ok = $_POST['internet'];
                    $internet_guy = $_POST['internet_guy'];
                    $internet_email = $_POST['internet_email'];
                    $referral = $_POST['referral'];

                    $query = "INSERT INTO apdata2k20(teamname,teamleader,email,phone,alternatephone,organization,reg_startup,city,member2,member3,member4,member5,member6,member7,member8,internet,internet_guy,internet_email,referral)
                    VALUES('$team_name','$team_leader','$email','$phone','$alt_phone','$college','$reg_startup','$city','$team2','$team3','$team4','$team5','$team6','$team7','$team8','$internet_ok','$internet_guy','$internet_email','$referral')";
                    ...
                    function sanitize_my_email($field) {     
                        ...
                        // <br>You need to submit your playbook till 10th November.<br>
                        // Kindly Submit your playbook on the link given below:<br>http://abhyudayiitb.org/actionplan/aplansubmission<br>
                        // Link for Playbook: http://abhyudayiitb.org/Actionplan/register/Playbook.pdf<br>
                        // Link for the Manual: http://abhyudayiitb.org/Actionplan/register/ActionPlanManual.pdf<br>
                        // Please be in touch with our managers for regular updates.<br>
                        // <br>Aditi Raj
                        // <br>Competition Manager
                        // <br>aditi@abhyudayiitb.org
                        // <br>+916355082880
                        // <br>
                        // <br>Yagna Shri Lakshmi
                        // <br>Competition Manager
                        // <br>yagnsri@abhyudayiitb.org
                        // <br>+919818281202";
                        ...
                        //     echo '<div class="alert alert-danger" role="alert">Invalid Mail Input</div>';
                        // } 
                        // else {//send email     
                        //     mail($to, $subject, $message, $headers);     
                        //    echo '<div class="alert alert-success" role="alert">Your reponse has been recorded, will get back to you soon.. </div>';
                        // }
